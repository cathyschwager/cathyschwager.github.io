		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->emporium, "0"); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->emporium, "0"); ?>]
			...
			<div id="page_content">
				...
				<div id="sidebar">
					...
					<ul>
						...
						<li><a href="Emporium.php">Emporium</a></li>
