	...
	<head>
		...
		<title>Children</title>	
				...
				<script type="text/javascript">
					...
					g_arrayCategoryBookmarks = ["Activity Books", "Board Books", "Cocky Circle", "Disney", "Golden Books", "Story Books"];
					...
					[
					  ...
					  [
					  	["Title 4", "Jane Doe", "4.00", "Book description 1", "/Children/images/image.jpg", "200"],
					  	["Title 5", "Jane Smith", "1.00", "Book description 2", "/Children/images/image.jpg", "300"],
					  	["Title 6", "Marg Bloggs", "3.00", "Book description 3", "/Children/images/image.jpg", "210"]
					  ],
					  /*List of books for Bookmark3*/
					  [
					  	["Title 7", "Susan Smith", "4.00", "Book description 1", "/Children/images/image.jpg", "370"],
					  	["Title 8", "Susan Bloggs", "1.00", "Book description 2", "/Children/images/image.jpg", "250"],
					  	["Title 9", "Susan Doe", "3.00", "Book description 3", "/Children/images/image.jpg", "190"]
					  ]
					];				</script>
