		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory["specialist"], $g_mapSubcategory["antiques"]); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory["specialist"], $g_mapSubcategory["antiques"]); ?>]
					...
					<ul>
						...
						<li onclick="DoToggleSpecialistPopupMenu()"><a href="#Top">Specialist</a></li>
							<div class="MenuPopup" id="MenuPopup" name="SpecialistPopupMenu">
								<ul>
									<li class="MenuPopupItem">
									<a href="AntiquePre1950.php">Antique pre-1950</a></li>
									<li class="MenuPopupItem">
