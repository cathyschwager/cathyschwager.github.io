		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory["specialist"], $g_mapSubcategory["mills_and_boon"]); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory["specialist"], $g_mapSubcategory["mills_and_boon"]); ?>]
						...
						<li onclick="DoToggleSpecialistPopupMenu()"><a href="#Top">Specialist</a></li>
							<div class="MenuPopup" id="MenuPopup" name="SpecialistPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="MillsAndBoon.php">Mills &amp; Boon</a></li>
									<li class="MenuPopupItem">
