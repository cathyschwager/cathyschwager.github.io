		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory["specialist"], $g_mapSubcategory["national_geographic"]); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory["specialist"], $g_mapSubcategory["national_geographic"]); ?>]
						...
						<li onclick="DoToggleSpecialistPopupMenu()"><a href="#Top">Specialist</a></li>
							<div class="MenuPopup" id="MenuPopup" name="SpecialistPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="../ReadersDigestCondensed/ReadersDigestCondensed.php">Reader's Digest Condensed</a></li>
									<li class="MenuPopupItem">
									<a href="../MillsAndBoon/MillsAndBoon.php">Mills &amp; Boon</a></li>
									<li class="MenuPopupItem">
									<a href="NationalGeographic.php">National Geographic</a></li>
									<li class="MenuPopupItem">
