		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->non_fiction, $g_mapSubcategory->autobiography); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->non_fiction, $g_mapSubcategory->autobiography); ?>]
						...
						<li onclick="DoToggleNonFictionPopupMenu()"><a href="#Top">Non-Fiction</a></li>
							<div class="MenuPopup" id="MenuPopup" name="NonFictionPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="AutoBiographies.php">Auto/Biography</a></li>
									<li class="MenuPopupItem">
									...
									<li class="MenuPopupItem">
									<a href="../Religion/Religion.php">Religion</a></li>
									<li class="MenuPopupItem">
