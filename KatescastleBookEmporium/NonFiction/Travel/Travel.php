		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->non_fiction, $g_mapSubcategory->travel); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->non_fiction, $g_mapSubcategory->travel); ?>]
