		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->non_fiction, $g_mapSubcategory->gardening); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->non_fiction, $g_mapSubcategory->gardening); ?>]
						...
						<li onclick="DoToggleNonFictionPopupMenu()"><a href="#Top">Non-Fiction</a></li>
							<div class="MenuPopup" id="MenuPopup" name="NonFictionPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="Gardening.php">Gardening</a></li>
									<li class="MenuPopupItem">
