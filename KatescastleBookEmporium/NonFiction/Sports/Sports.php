	...
	<head>
		...
		<style>
				...
				<script type="text/javascript">
					...
					g_arrayCategoryBookmarks = ["Aquatics", "Athletics", "Baseball", "Basketball", "Billiards", "Boxing", 
												"Cricket",  "Equestrian", "Extreme Sports", "Fishing", "Football", "Golf", 
												"Martial Arts",  "Racquet Sports", "Sailing", "Other"];					
