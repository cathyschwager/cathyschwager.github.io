...
-->						
		...
		<style>
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory["non_fiction"], $g_mapSubcategory["religion"]); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory["non_fiction"], $g_mapSubcategory["religion"]); ?>]
