	...
	<head>
		...
		<style>
				...
				<script type="text/javascript">
					...
					g_arrayCategoryBookmarks = ["Drinks", "Desserts", "Food", "Herbs", "Microwave", "Recipe", "Traditional", "Other"];
		...
		<div id="container">
			...
			<div id="page_content">
				...
				<div id="content">
					...
					<h4>Book Title</h4>
					<p>XXXXXXXXX</p>
					<script type="text/javascript">GenerateTopButton();</script>
