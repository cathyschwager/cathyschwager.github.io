	...
	<head>
		...
		<title>Requests</title>
				...
				<script type="text/javascript">
					...
					g_arrayCategoryBookmarks= ["We're Looking For", "You're Looking For" ];
					
					g_arrayCategoryBookLists =
					[
					  // List of books for "You're Looking For"
					  [
					  	["Title 10", "Fred Smith", "4.00", "Book description 1", "/Children/images/image.jpg", "120"],
					  	["Title 11", "Joe Bloggs", "1.00", "Book description 2", "/Children/images/image.jpg", "170"],
					  	["Title 12", "John Doe", "3.00", "Book description 3", "/Children/images/image.jpg", "80"]
					  ],
					  // List of books for "We're Looking For"
					  [
					  	["Title 13", "Fred Smith", "4.00", "Book description 1", "/Children/images/image.jpg", "230"],
					  	["Title 14", "Joe Bloggs", "1.00", "Book description 2", "/Children/images/image.jpg", "176"],
					  	["Title 15", "John Doe", "3.00", "Book description 3", "/Children/images/image.jpg", "103"]
					  ],
					];
