			...
			<div id="page_content">
				...
				<div id="sidebar">
					...
					<ul>
						...
						<li>
						<a href="FAQ/FAQ.php">FAQ</a></li>
						<li>
						<a href="LearnToCode/LearnToCode.html">Learn to code</a></li>
						<li>
						<a href="Requests/Requests.php">Requests</a></li>
						<li>
						<a href="Children/Children.php">Children</a></li>
						<li>
						<a href="Emporium/Emporium.php">Emporium</a></li>
						...
						<li>
						<a href="YoungAdults/YoungAdults.php">Young Adults</a></li>
						<li>
						<a href="admin.php">Admin Login</a></li>
					</ul>
				</div>
				<!-- End Sidebar -->
				<!-- Begin Content -->
