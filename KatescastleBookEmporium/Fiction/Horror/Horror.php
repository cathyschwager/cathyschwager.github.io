		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->fiction, $g_mapSubcategory->horror); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->fiction, $g_mapSubcategory->horror); ?>]
