	...
	<head>
		...
		<style>
				...
				<script type="text/javascript">
					...
					g_arrayBookmarks = ["Cleveland", "Larry and Stretch", "Louis L'Amour", "Zane Grey", "Other"];
		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					const arrayCategoryBookmarks= ["Civil War", "Indian Wars", "Gold", "Outlaws", "Mexican War", "Pioneers", "Other"];
						...
						<li onclick="DoToggleFictionPopupMenu()"><a href="#top">Fiction</a></li>
							<div class="MenuPopup" id="MenuPopup" name="FictionPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="Westerners.html">Westerns</a></li>
								</ul>
							</div>
