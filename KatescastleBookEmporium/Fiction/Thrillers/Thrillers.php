		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->fiction, $g_mapSubcategory->thrillers); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->fiction, $g_mapSubcategory->thrillers); ?>]
						...
						<li onclick="DoToggleFictionPopupMenu()"><a href="#top">Fiction</a></li>
							<div class="MenuPopup" id="MenuPopup" name="FictionPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="../Fantasy/Fantasy.php">Fantasy</a></li>
									<li class="MenuPopupItem">
									...
									<li class="MenuPopupItem">
									<a href="../Romance/Romance.php">Romance</a></li>
									<li class="MenuPopupItem">
									<a href="../Sagas/Sagas.php">Sagas</a></li>
									<li class="MenuPopupItem">
									<a href="../Science/science.php">Science</a></li>
									<li class="MenuPopupItem">
									<a href="Thrillers.php">Thrillers</a></li>
									<li class="MenuPopupItem">
									<a href="../Westerns/Westerns.php">Westerns</a></li>
								</ul>
							</div>
