		...
		<!-- #EndEditable -->
			...
			<!-- #BeginEditable "Subcategories" -->
				...
				<script type="text/javascript">
					...
					g_arrayTopicBookmarks = [<?php DoGetTopics($g_mapCategory->fiction, $g_mapSubcategory->mystery); ?>];
					g_arrayTopicBookLists =[<?php DoGetBooks($g_mapCategory->fiction, $g_mapSubcategory->mystery); ?>]
						...
						<li onclick="DoToggleFictionPopupMenu()"><a href="#top">Fiction</a></li>
							<div class="MenuPopup" id="MenuPopup" name="FictionPopupMenu">
								<ul>
									...
									<li class="MenuPopupItem">
									<a href="Mystery.php">Mystery</a></li>
									<li class="MenuPopupItem">
